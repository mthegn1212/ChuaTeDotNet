    ...
    public static class SeedData
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<MenuItem>().HasData(
                ...
                new MenuItem { Id = 4, Name = "PostProject", Link = "/PostProject", Meta = "post-project", Hide = false, Order = 4, DateBegin = DateTime.Now },
                new MenuItem { Id = 5, Name = "Project Management", Link = "/ProjectManagement", Meta = "project-management", Hide = false, Order = 5, DateBegin = DateTime.Now }
            );
